...
public class ModBlockPadlockGolden extends BlockContainer implements IBlock{

	protected ModBlockPadlockGolden(String name) {
		super(Material.iron);
	...
	public TileEntity createNewTileEntity(World world, int i1) {
		return new TileEntityPadlockGolden();
	}
	@Override
	...
	public void setBlockBoundsBasedOnState(IBlockAccess access, int x, int y, int z){
		...
		if(meta == 3  || meta == 7){
			this.setBlockBounds(0.65F, 0.0F, 0.0F, 0.95F, 0.56F, 0.15F);
		}else if(meta == 4 || meta == 8){
			this.setBlockBounds(0.85F, 0.0F, 0.65F, 1.0F, 0.56F, 0.95F);
		}else if(meta == 2 || meta == 6){
			this.setBlockBounds(0.0F, 0.0F, 0.05F, 0.15F, 0.56F, 0.35F);
		}else{
			this.setBlockBounds(0.05F, 0.0F, 0.85F, 0.35F, 0.56F, 1.0F);
		}
	}
	@Override
