...
public class RenderCrowbar implements IItemRenderer{
	...
	public RenderCrowbar(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/items/crowbar_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/crowbar.obj");
