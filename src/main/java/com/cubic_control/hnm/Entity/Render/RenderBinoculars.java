...
public class RenderBinoculars implements IItemRenderer{
	...
	public RenderBinoculars(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/items/binoculars_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/binoculars.obj");
