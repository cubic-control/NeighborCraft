...
public class RenderKey implements IItemRenderer{
	...
	public RenderKey(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/items/key_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/key.obj");
