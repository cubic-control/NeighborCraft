...
public class RenderNailPuller implements IItemRenderer{
	protected static ResourceLocation textureLocation;
	protected static ResourceLocation modelLocation;
	
	IModelCustom model;
	
	public RenderNailPuller(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/items/nail-puller_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/nail-puller.obj");
