...
import com.cubic_control.hnm.Entity.Model.ModelCamera;
...
public class RenderCamera extends TileEntitySpecialRenderer{
	...
	public RenderCamera(){
		model = new ModelCamera();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/blocks/camera.png");
	}
