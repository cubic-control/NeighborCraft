...
public class RenderRifle implements IItemRenderer{
	...
	public RenderRifle(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/rifle_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/rifle.obj");
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED:
			...
			GL11.glRotatef(90F, -6.1f, -3.0f, 0.0f);
			GL11.glTranslatef(-25.0f, -35.0f, -0.0f);
			break;
		case EQUIPPED_FIRST_PERSON:
