...
public class RenderKey_player implements IItemRenderer{
	protected static ResourceLocation textureLocation;
	protected static ResourceLocation modelLocation;
	
	IModelCustom model;
	
	public RenderKey_player(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/lock_player_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/key_player.obj");
