...
public class RenderElectromagnetV2 implements IItemRenderer{
	protected static ResourceLocation textureLocation;
	protected static ResourceLocation modelLocation;
	
	IModelCustom model;
	
	public RenderElectromagnetV2(){
		textureLocation = new ResourceLocation(RefStrings.MODID + ":textures/models/blue_noise_dif.png");
		modelLocation = new ResourceLocation(RefStrings.MODID + ":obj/items/electromagnet_v2.obj");
